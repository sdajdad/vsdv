...
exports.run = (client, message) => {
    let zulapng = "https://st.depositphotos.com/1954151/1976/v/950/depositphotos_19760591-stock-illustration-pirate-flag.jpg"
    var destedencikanlar = [
        "M4A1 **Mekatronik Desen**",
        ...
        "AUG A3 **Horoz Desen**",
        "AUG A3 **Gümüş Desen**",
        "AUG A3 **Siyah Quantum**",
        "M6 LWRC **Mekatronik Desen**",
        "M6 LWRC **Kabus Desen**",
        "M6 LWRC **Sultan Desen**",
        "M6 LWRC **Altın Desen**",
        "M6 LWRC **Grafiti Desen**",
        "M6 LWRC **Horoz Desen**",
        "DSR1 **Mekatronik Desen**",
        "DSR1 **Kabus Desen**",
        "DSR1 **Raptor Desen**",
        "DSR1 **Altın Desen**",
        "DSR1 **Sultan Desen**",
        ...
        "M93R **Truva Desen**",
        "M93R **Zehir Desen**",
        "Desert Deagle **Mekatronik Desen",
